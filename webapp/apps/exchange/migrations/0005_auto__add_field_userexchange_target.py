...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserExchange.target'
        db.add_column(u'exchange_userexchange', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='userexchange_set2', null=True, blank=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserExchange.target'
        db.delete_column(u'exchange_userexchange', 'target_id')
